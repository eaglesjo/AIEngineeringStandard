...
REQUIRED_FILES = [
    ...
    "tests/validation/fixtures/conformance-result.pass.json", "tests/validation/fixtures/security-result.pass.json", "tests/validation/fixtures/portable-skill/SKILL.md", "scripts/validation/validate_2_0_schemas.py", "scripts/validation/validate_portable_skill.py", "scripts/validation/run_conformance.py",
...
def run_2_0_validation() -> None:
    ...
    run_checker(ROOT / "scripts" / "validation" / "run_conformance.py", "AIEngineeringStandard 2.0 static conformance", "--agent", "codex")
