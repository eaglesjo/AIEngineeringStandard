...
REQUIRED_FILES = [
    "VERSION", "AGENTS.md", "CLAUDE.md", "GEMINI.md", "INSTALL.md", "core/common/AGENT.md", "core/common/SKILL.md", "core/common/ENVIRONMENT.md", "core/common/environment.py", "core/common/experiment.py", "core/common/dependencies.py", "core/agent/README.md", "core/skill/README.md", "core/skill/PORTABLE_SKILL_CONTRACT.md", "core/plugin/README.md", "core/mcp/README.md", "core/validation/README.md", "core/validation/conformance-result.schema.json", "core/validation/conformance-evidence.schema.json", "core/validation/SECURITY_PROVENANCE_CONTRACT.md", "core/validation/security-result.schema.json", "profiles/agent/README.md", "compatibility/agents.json",
    "domains/ml/AGENT.md", "domains/ml/SKILL.md", "domains/ml/ENVIRONMENT.md", "domains/ml/README.md", "domains/ml/skills/README.md", "domains/ml/skills/data/SKILL.md", "domains/ml/skills/evaluation/SKILL.md", "domains/ml/skills/experiment/SKILL.md", "domains/ml/skills/training/SKILL.md", "domains/ml/skills/distributed-training/SKILL.md", "domains/ml/skills/hyperparameter-optimization/SKILL.md", "domains/ml/skills/inference/SKILL.md", "domains/ml/skills/mlops/SKILL.md", "domains/llm/AGENT.md", "domains/llm/SKILL.md", "domains/llm/ENVIRONMENT.md", "domains/llm/environment.py", "domains/llm/memory_smoke_test.py", "domains/llm/experiment.py", "domains/llm/skills/finetuning/SKILL.md", "domains/llm/skills/peft/SKILL.md", "domains/llm/skills/quantization/SKILL.md", "domains/llm/skills/rag/SKILL.md", "domains/vision/AGENT.md", "domains/vision/SKILL.md", "domains/vision/ENVIRONMENT.md", "domains/vision/memory_smoke_test.py", "domains/vision/README.md", "platform/colab/AGENT.md", "platform/colab/SKILL.md", "platform/colab/validate_runtime.py", "examples/colab/clean_runtime_validation.ipynb", "examples/colab/llm_qlora_validation.ipynb", "docs/development/ML_RUNTIME_VALIDATION.md", "tests/integration/ml_classification_smoke.py", "tests/integration/llm_qlora_strategy_smoke.py",
    "tests/validation/fixtures/conformance-result.pass.json", "tests/validation/fixtures/conformance/codex-static.expected.json", "tests/validation/fixtures/conformance/codex-runtime.scenario.json", "tests/validation/fixtures/conformance/codex-runtime-failure-recovery.scenario.json", "tests/validation/fixtures/security-result.pass.json", "tests/validation/fixtures/portable-skill/SKILL.md", "scripts/validation/validate_2_0_schemas.py", "scripts/validation/validate_portable_skill.py", "scripts/validation/run_conformance.py", "scripts/validation/validate_conformance_fixture.py", "scripts/validation/run_runtime_conformance.py",
...
def run_checker(path: Path, label: str, *args: str) -> None:
    proc = subprocess.run([sys.executable, str(path), *args], cwd=str(ROOT), capture_output=True, text=True, check=False)
...
def run_2_0_validation() -> None:
    ...
    run_checker(ROOT / "scripts" / "validation" / "run_conformance.py", "AIEngineeringStandard 2.0 static conformance", "--agent", "codex", "--check-only", "--output", "/tmp/codex-conformance.json")
    run_checker(ROOT / "scripts" / "validation" / "validate_conformance_fixture.py", "AIEngineeringStandard 2.0 conformance fixture", "--agent", "codex", "--result", "/tmp/codex-conformance.json")
    run_checker(ROOT / "scripts" / "validation" / "run_runtime_conformance.py", "AIEngineeringStandard 2.0 runtime harness dry run", "--agent", "codex", "--output", "/tmp/codex-runtime-conformance.json")
