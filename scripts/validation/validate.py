...
REQUIRED_FILES = [
    ...
    "core/agent/README.md", "core/skill/README.md", "core/skill/PORTABLE_SKILL_CONTRACT.md", "core/plugin/README.md", "core/mcp/README.md", "core/validation/README.md", "core/validation/conformance-result.schema.json", "core/validation/conformance-evidence.schema.json", "core/validation/SECURITY_PROVENANCE_CONTRACT.md", "core/validation/security-result.schema.json", "profiles/agent/README.md", "compatibility/agents.json",
